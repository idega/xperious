        	...
        	$.each(this.$(selector), function(){
        	    ...
        	    if ($el.css('background-image')) {
        	    	...
        	    	if (src !== 'none') {
	        	    	...
	        	    	$el.append('<div class="loader" data-src="' + src + '"><img src="' + loader + '" /></div>');
        	    	}
        	    }
        	});
